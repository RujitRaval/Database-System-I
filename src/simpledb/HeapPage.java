...
public class HeapPage implements Page {
	...
	public Iterator<Tuple> iterator() {
		...
		while( i != entryCount())
		{
			final Iterator<Tuple> new_iterator = new Iterator<Tuple>() {
				...
				public Tuple next() {
					...
					{
						entryID++;
						Tuple T = getTuple(entryID);	
						if(T == null)
							throw new UnsupportedOperationException("Tuple is deleted !");
						else
							return T;
					}
					return null;
...
//					
	...
	public void deleteTuple(Tuple t) throws DbException {
		// some code goes here
		int x = t.getRecordId().tupleno();
		saveTupleLocation(-1, x);
	...
	public void addTuple(Tuple t) throws DbException {
		...
		if(!(freeSpaceSize() < b.length + 4))
		{
			...
			saveEntryCount(location);
			saveTupleLocation(b.length, location);
			t.setRecordId(new RecordId(pid, location));
		}
		else
		{
			throw new DbException("Page can not be added");
		}
		throw new UnsupportedOperationException("Implement this");
	}
